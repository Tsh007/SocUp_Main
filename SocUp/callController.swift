...
//edits to be done for version 2.0 later after improving the ui
//1-- add a call end button and navigation bar at top
//2-- implement skip button through which user will start new call
//3-- make the room delete when user ends the call
//4-- add snapshot listners 
...
//        webConfiguration.allowsInlineMediaPlayback = true
        ...
        //most important line to make stream play in webView
...
//                self.callJSFunctionFromSwift(function: "startCall("+connId+")")
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//            newReference.child("users").child(friendsUid).child("connId").observe(.childChanged) { snapshot,arg  in
...
//        database.child("users").child(createdBy).setValue(nil)
//        print("did closed called")
